...
cat <<EOF > gsiparm.anl
 ...
 &SETUP
   ...
   l4densvar=${if4d},nhr_obsbin=1,min_offset=90,
   use_gfs_nemsio=${if_gfs_nemsio},netcdf_diag=.false.,binary_diag=.true.,
 /
 &GRIDOPTS
   JCAP=62,JCAP_B=62,NLAT=${nlat},NLON=${nlon},nsig=${nsig},regional=.true.,
 ...
 /
 &OBS_INPUT
   dmesh(1)=120.0,dmesh(2)=60.0,dmesh(3)=10.0,time_window_max=${half_window},ext_sonde=.true.,
 /
OBS_INPUT::
!  dfile          dtype       dplat     dsis                 dval    dthin dsfcalc
   ...
   hirs3bufr      hirs3       n16       hirs3_n16            0.0     2     0
   hirs3bufr      hirs3       n17       hirs3_n17            6.0     2     0
   hirs4bufr      hirs4       metop-a   hirs4_metop-a        6.0     2     0
   hirs4bufr      hirs4       n18       hirs4_n18            0.0     2     0
   hirs4bufr      hirs4       n19       hirs4_n19            1.0     2     0
   hirs4bufr      hirs4       metop-b   hirs4_metop-b        1.0     2     0
   gimgrbufr      goes_img    g11       imgr_g11             0.0     2     0
   gimgrbufr      goes_img    g12       imgr_g12             0.0     2     0
   ...
   amsubbufr      amsub       n17       amsub_n17            1.0     2     0
   ...
   gsnd1bufr      sndrd1      g12       sndrD1_g12           1.5     2     0
   gsnd1bufr      sndrd2      g12       sndrD2_g12           1.5     2     0
   gsnd1bufr      sndrd3      g12       sndrD3_g12           1.5     2     0
   gsnd1bufr      sndrd4      g12       sndrD4_g12           1.5     2     0
   gsnd1bufr      sndrd1      g11       sndrD1_g11           1.5     2     0
   gsnd1bufr      sndrd2      g11       sndrD2_g11           1.5     2     0
   gsnd1bufr      sndrd3      g11       sndrD3_g11           1.5     2     0
   gsnd1bufr      sndrd4      g11       sndrD4_g11           1.5     2     0
   gsnd1bufr      sndrd1      g13       sndrD1_g13           1.5     2     0
   gsnd1bufr      sndrd2      g13       sndrD2_g13           1.5     2     0
   gsnd1bufr      sndrd3      g13       sndrD3_g13           1.5     2     0
   gsnd1bufr      sndrd4      g13       sndrD4_g13           1.5     2     0
   ...
   iasibufr       iasi        metop-a   iasi_metop-a        20.0     2     0
   ...
   seviribufr     seviri      m08       seviri_m08           1.0     2     0
   seviribufr     seviri      m09       seviri_m09           1.0     2     0
   seviribufr     seviri      m10       seviri_m10           1.0     2     0
   seviribufr     seviri      m11       seviri_m11           1.0     2     0
   iasibufr       iasi        metop-b   iasi_metop-b         0.0     2     0
   gomebufr       gome        metop-b   gome_metop-b         0.0     2     0
   atmsbufr       atms        npp       atms_npp             0.0     2     0
   atmsbufr       atms        n20       atms_n20             0.0     2     0
   crisbufr       cris        npp       cris-frs_npp        0.0     2     0
   crisbufr       cris        n20       cris-frs_n20         0.0     2     0
